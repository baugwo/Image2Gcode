package org.lmn.laserRaster.assets
{
	...
	public class SpriteSheet extends Sprite
	{
		...
		public function SpriteSheet(tileSheetBitmap:Bitmap, width:Number = 18, height:Number = 18, margin:Number=8)//18 was 16
		{
			...
			tileRectangle = new Rectangle(0, 0, tileWidth-margin, tileHeight-margin);
			tilePoint = new Point(0, 0);

			canvasBitmapData = new BitmapData(tileWidth-margin, tileHeight-margin, true);
